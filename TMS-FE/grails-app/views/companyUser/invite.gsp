...
<html>
    ...
    <body>
        ...
        <div class="body">
            ...
            <div class="list">
                ...
                <div class="result" style="padding-top:15px">
                	<g:each  in="${results}"  status="i" var="res" >
                		...
                		<div class="${(i % 2) == 0 ? 'odd' : 'even'}" style="padding:15px">${res.firstname } &nbsp; ${res.lastname } <g:hiddenField name="userId" value="${res.id }" />
                			<g:if test="${invitations.contains(res)}">
                				<strong>Already Invite</strong>
                			</g:if>
                			<g:else>
                				<g:submitButton name="Invite This User"/>    				
                			</g:else>               			
            ...
            <g:if test="${resultsTotal > 0}">
           <div class="paginateButtons">
   				<g:paginate  total="${resultsTotal}" params="${params}" />
			</div>
            </g:if>
